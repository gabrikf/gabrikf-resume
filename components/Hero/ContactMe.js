...
const ContactMe = () => {
  return (
    <div className='mr-20 mx-8 px-8 relative border-red-800 border-2 rounded md:px-16 pb-4 pt-10 mt-6'>
          ...
          <p>
            <a href='https://www.linkedin.com/in/gabriel-koch-fodi-36b12b8b/'><FaLinkedin className='text-6xl hover:text-blue-600 inline-block mr-6 ml-6'/></a>
            <a href='https://github.com/gabrikf'><FaGithub  className='text-6xl hover:text-purple-600 inline-block '/></a>
            <br />
